...
class BinaryBaseModel(object):
    ...
    def __init__(self, opt):
        ...
        self.img_enc = image_net.ResNetEncoder(opt)
    ...
    def forward_emb(self, epoch, batch_data, volatile=False):
        ...
        # forward image
        img_code = self.img_enc(raw_image)
    ...
    def forward_loss(self, epoch, img_emb, cap_emb, re_phrase_emb, adv_emb, cap_len, sample_index, **kwargs):
        ...
        if epoch > 5 and re_phrase_emb is not None and adv_emb is not None:
